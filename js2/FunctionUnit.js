...
// (function () {
    ...
    FunctionUnit.prototype = {
        constructor:FunctionUnit,
        clear: function () {//初始化功能部件
            this.busy = false;
            this.Op = "";
            this.Fi = "";
            this.Fj = "";
        ...
        loadInstruction: function (instruction, registers, clock) {//加载一条指令
        ...
        forwardPipeline: function (registers, clock) {//功能部件随着时钟周期，运行下一个指令阶段
            // 当前功能部件未加载指令或指令已执行结束
        ...
        updateInfo: function (registers) {//更新功能部件信息
            if (this.exec != 1) {
                return;
            }
            if (this.Rj=="Yes" && this.Rk=="Yes") {
...
// window.FunctionUnit=FunctionUnit;
// }());